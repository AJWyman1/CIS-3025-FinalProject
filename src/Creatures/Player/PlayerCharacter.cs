...
class PlayerCharacter : Creature
{
    ...
    public void SelectClass()
    {
        ...
        this.PlayerClass = (Class)Array.IndexOf(options, input);
        ...
        string[] ClassProficiencies =
        {
            ...
            "light nonmetal armor, medium nonmetal armor, shield (nonmetal), club, dagger, dart, javelin, mace, quarterstaff, scimitar, sickle, sling, spear, ",
